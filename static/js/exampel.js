...
var requestHandle = {
	...
	_getParams:function(data){
		...
		var sendPostParam = {mid:attributes.mid, ptt:attributes.ptt, ian:attributes.ian};
		...
		var specialdata = 'un=xxx'+'&mid='+sendPostParam.mid+'&ptt='+sendPostParam.ppt+'&ian='+sendPostParam.ian;
